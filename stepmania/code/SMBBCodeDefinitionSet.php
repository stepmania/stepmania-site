...
class UrlValidator implements JBBCode\InputValidator
{
	public function validate($input)
	{
		...
		// Make sure it's not the javascript scheme
		// Maybe we should use a whitelist later?
		if (!$valid_url || preg_match("/javascript/ui", strtolower(parse_url($input)["scheme"])))
			return false;
		return true;
	}
}
